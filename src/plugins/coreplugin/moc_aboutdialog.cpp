...
static const char qt_meta_stringdata_Core__Internal__AboutDialog[] = {
    "Core::Internal::AboutDialog\0"
};

void Core::Internal::AboutDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData Core::Internal::AboutDialog::staticMetaObjectExtraData = {
...
const QMetaObject Core::Internal::AboutDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Core__Internal__AboutDialog,
      qt_meta_data_Core__Internal__AboutDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Core::Internal::AboutDialog::getStaticMetaObject() { return staticMetaObject; }
